...
replicates_per_pop <- pop_map2_IDs %>%
...
final_subset <- anti_join(subsample, last_samples_to_remove,
                          by = "sample")
...
allele_frqs <- conStruct::structure2conStruct(
  ...
  start.samples = 2,
  missing.datum = -9,
  outfile = here("./clean_data/construct_data_20230529_2"))
```
