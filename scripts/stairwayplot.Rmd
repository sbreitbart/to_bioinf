...
ggsave("./Figures_Tables/Stairway_plot/mu_1.8e-8/gen_time_1yr/entirepop_conf_ints.png",
       width = 17,
       height = 9,
       units = "cm")
```
...
ggsave("./Figures_Tables/Stairway_plot/mu_1.8e-8/gen_time_1yr/entirepop_inset_conf_ints.png",
       width = 17,
       height = 9,
       units = "cm")
```
...
ggsave("./Figures_Tables/Stairway_plot/mu_1.8e-8/gen_time_1yr/distance/urb_inset_conf_ints.png",
       width = 17,
       height = 9,
       units = "cm")
```
...
ggsave("./Figures_Tables/Stairway_plot/mu_1.8e-8/gen_time_1yr/distance/rur_inset_conf_ints.png",
       width = 17,
       height = 9,
       units = "cm")
```
