...
### mu = 1x10^-8 & generation time = 1 year
#### All sites in 1 population
```{r}
full_fig_1e8 <- read.delim(here::here("./StairwayPlot/mu_1e-8/full_mmaf0.007813_mut_rate_1e-8/full_mmaf0.007813_mut_rate_1e-8.final.summary")) %>%
...
##### Dist to CC
```{r}
# urb_fig <- read.delim(here::here("./StairwayPlot/mu_1.2e-8/urban_dist_mmaf0.007813/urban_dist_mmaf0.007813.final.summary")) %>%
#   dplyr::select(-c(theta_per_site_median,
#                    theta_per_site_2.5.,
#                    theta_per_site_97.5.,
#                    n_estimation,
...
##### Urb Score
```{r}
# urb_fig2 <- read.delim(here::here("./StairwayPlot/mu_1.2e-8/urban_usc_mmaf0.007813/urban_usc_mmaf0.007813.final.summary")) %>%
#   dplyr::select(-c(theta_per_site_median,
#                    theta_per_site_2.5.,
#                    theta_per_site_97.5.,
#                    n_estimation,
...
##### Dist to CC
```{r}
# rur_fig <- read.delim(here::here("./StairwayPlot/mu_1.2e-8/rural_dist_mmaf0.007813/rural_dist_mmaf0.007813.final.summary")) %>%
#   dplyr::select(-c(theta_per_site_median,
#                    theta_per_site_2.5.,
#                    theta_per_site_97.5.,
#                    n_estimation,
...
##### Urb score
```{r}
# rur_fig2 <- read.delim(here::here("./StairwayPlot/mu_1.2e-8/rural_usc_mmaf0.007813/rural_usc_mmaf0.007813.final.summary")) %>%
#   dplyr::select(-c(theta_per_site_median,
#                    theta_per_site_2.5.,
#                    theta_per_site_97.5.,
#                    n_estimation,
...
#### All sites in 1 population
```{r}
full_fig <- read.delim(here::here("./StairwayPlot/mu_1.2e-8/full_mmaf0.007813/full_mmaf0.007813.final.summary")) %>%
  dplyr::select(-c(theta_per_site_median,
                   theta_per_site_2.5.,
                   theta_per_site_97.5.,
                   n_estimation,
...
#### All sites in 1 population
```{r}
full_fig_1.8e8 <- read.delim(here::here("./StairwayPlot/mu_1.8e-8/full_mmaf0.007813_mut_rate_1.8e-8/full_mmaf0.007813_mut_rate_1.8e-8.final.summary")) %>%
  dplyr::select(-c(theta_per_site_median,
                   theta_per_site_2.5.,
                   theta_per_site_97.5.,
                   n_estimation,
...
# find median Ne around 500 years ago
median_ne_500YA <- Ne_df %>%
  dplyr::filter(year > 500 & year < 501) %>%
  dplyr::select(Ne_median) %>%
  dplyr::mutate(Ne_median = round(Ne_median, 0)) %>%
  slice(1) %>%
  as.numeric()

print(paste0("Median Ne ~500 years ago: ", median_ne_500YA*1000))
...
perc_decrease <- round(((most_recent_ne-median_ne_500YA)/median_ne_500YA ) * 100, 3)
