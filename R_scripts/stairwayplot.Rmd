...
print(paste0("Median Ne ~500 years ago: ", median_ne_500YA))
...
print(paste0("Most recent median Ne: ", most_recent_ne))
...
## Total, urban, & rural in same plot
### Merge dfs
#### Urb = dist to CC
```{r}
...
cowplot::ggdraw() +
  ...
  filename = here::here("./Figures_Tables/Stairway_plot/Reg_scale_y/all_with_inset_reg_scale.png"),
         height = 5,
         width = 9,
         dpi = 200)
```
...
cowplot::ggdraw() +
  ...
  filename = here::here("./Figures_Tables/Stairway_plot/Reg_scale_y/all_with_inset_reg_scale_urbscore.png"),
         height = 5,
         width = 9,
         dpi = 200)
```
...
#### Urb = dist to CC
```{r}
all_plot_log10 <- ggplot(all_dist)  +
...
### Plot inset (past 2300 years)
all_plot_log10_inset <- all_plot_log10 +
    scale_x_continuous(limits = c(NA, 2300),
                       labels = scales::comma) +
    theme(axis.title = element_blank(),
          plot.background = element_rect(
...
ggsave(plot = 
         ...
         ### Overlay inset in full figure
cowplot::ggdraw() +
    draw_plot(all_plot_log10) +
    draw_plot(all_plot_log10_inset,
              x = 0.4,
              y = 0.15, 
              width = 0.4,
              height = 0.5),
  ...
  filename = here::here("./Figures_Tables/Stairway_plot/all_with_inset.png"),
         height = 5,
         width = 9,
         dpi = 200)
```
...
#### Urb = urb score
```{r}
all_plot_log10_usc <- ggplot(all_usc)  +
...
### Plot inset (past 2300 years)
all_plot_log10_inset_usc <- all_plot_log10_usc +
    scale_x_continuous(limits = c(NA, 2300),
                       labels = scales::comma) +
    theme(axis.title = element_blank(),
          plot.background = element_rect(
...
ggsave(plot = 
         ...
         ### Overlay inset in full figure
cowplot::ggdraw() +
    draw_plot(all_plot_log10_usc) +
    draw_plot(all_plot_log10_inset_usc,
              x = 0.4,
              y = 0.15, 
              width = 0.4,
              height = 0.5),
  ...
  filename = here::here("./Figures_Tables/Stairway_plot/all_with_inset_urbscore.png"),
         height = 5,
         width = 9,
         dpi = 200)
```
