...
ggplot(
  ...
  # Export
  ggsave(filename = here::here("./Figures_Tables/Stairway_plot/full_no_inset_reg_scale.png"),
         height = 5,
         width = 7,
         dpi = 200)
```
...
# Export
ggsave(filename = here::here("./Figures_Tables/Stairway_plot/full_inset_200yrs.png"),
         height = 5,
         width = 7,
         dpi = 200)
```
...
# Export
ggsave(filename = here::here("./Figures_Tables/Stairway_plot/full_inset_800yrs.png"),
         height = 5,
         width = 7,
         dpi = 200)
```
...
ggsave(last_plot(),
       file = here::here("./Figures_Tables/Stairway_plot/Toronto_population.png"),
       height = 5,
         width = 7,
         dpi = 200)
