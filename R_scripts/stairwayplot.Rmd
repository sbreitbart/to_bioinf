...
all_pop <- read.csv(here::here("./raw_data/human_population/human_population_Canada_raw_after2007.csv")) %>%
  ...
  dplyr::full_join(human_pop2,
                   .,
                   by = c("Year", "Population", "years_before_present"))  %T>%
  # export
  write.csv(.,
          file =
            here::here("./clean_data/human_population_Canada_clean.csv"))
...
ggsave(last_plot(),
       file = here::here("./Figures_Tables/Stairway_plot/Canada_population.png"),
       height = 5,
         width = 7,
         dpi = 200)
...
ggsave(last_plot(),
       file = here::here("./Figures_Tables/Stairway_plot/Ontario_population.png"),
       height = 5,
         width = 7,
         dpi = 200)
