...
### Clusters = 1
Didn't work (not going to work. DAPC can only detect at least 2 clusters, as per conversation with package developers May 2023)
But upon revisiting in the fall, I can explore data with 1 cluster...
#### Examine clusters
```{r}
head(grp$Kstat)  # BIC scores per k
#      K=1      K=2      K=3      K=4      K=5      K=6 
...
### Export
```{r}
adonis_export(adonis_dist1, "adonis_dist_quant")
adonis_export(adonis_usc1, "adonis_usc_quant")
adonis_export(adonis_dist2, "adonis_dist_categ")
adonis_export(adonis_usc2, "adonis_usc_categ")
```
...
### Export anovas
```{r}
bd_export(bd_centroid, "bd_dist")
bd_export(bd_centroid_usc, "bd_usc")
```
