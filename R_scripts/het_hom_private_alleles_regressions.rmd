...
Het_exp_dist_plot <- plot(Het_exp_dist_pred, 
     add.data = F) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
                  ymax = conf.high),
...
Het_exp_usc_plot <- plot(Het_exp_usc_pred, 
     add.data = F) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
                  ymax = conf.high),
...
Het_obs_dist_plot <- plot(Het_obs_dist_pred, 
     add.data = F,
     alpha = 0) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
...
Het_obs_usc_plot <- plot(Het_obs_usc_pred, 
     add.data = F,
     alpha = 0) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
...
Hom_exp_dist_plot <- plot(Hom_exp_dist_pred, 
     add.data = F) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
                  ymax = conf.high),
...
Hom_exp_usc_plot <- plot(Hom_exp_usc_pred, 
     add.data = F) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
                  ymax = conf.high),
...
Hom_obs_dist_plot <- plot(Hom_obs_dist_pred, 
     add.data = F,
     alpha = 0) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
...
Hom_obs_usc_plot <- plot(Hom_obs_usc_pred, 
     add.data = F,
     alpha = 0) +
  geom_ribbon(aes(x = x,
                  ymin = conf.low,
...
```{r}
# City distance plots
(Het_exp_dist_plot | Het_obs_dist_plot) /
(Hom_exp_dist_plot | Hom_obs_dist_plot )
...
(Het_exp_usc_plot | Het_obs_usc_plot) / 
(Hom_exp_usc_plot | Hom_obs_usc_plot )
...
Het_exp_dist_plot2 <- ggplot(data = Het_exp_dist_pred_cat,
         aes(x = x, y = predicted)) +
...
Het_exp_usc_plot2 <- ggplot(data = Het_exp_usc_pred_cat,
         aes(x = x, y = predicted)) +
        geom_point(color = "black",
                   size = 2) + 
    geom_errorbar(aes(ymin = conf.low,
...
Hom_exp_dist_plot2 <- ggplot(data = Hom_exp_dist_pred_cat,
         aes(x = x, y = predicted)) +
        geom_point(color = "black",
                   size = 2) + 
    geom_errorbar(aes(ymin = conf.low,
...
Hom_exp_usc_plot2 <- ggplot(data = Hom_exp_usc_pred_cat,
         aes(x = x, y = predicted)) +
        geom_point(color = "black",
                   size = 2) + 
    geom_errorbar(aes(ymin = conf.low,
...
Hom_obs_dist_plot2 <- ggplot(data = Hom_obs_dist_pred_cat,
         aes(x = x, y = predicted)) +
        geom_point(color = "forestgreen",
                   size = 2) + 
    geom_errorbar(aes(ymin = conf.low,
...
Hom_obs_usc_plot2 <- ggplot(data = Hom_obs_usc_pred_cat,
         aes(x = x, y = predicted)) +
        geom_point(color = "forestgreen",
                   size = 2) + 
    geom_errorbar(aes(ymin = conf.low,
...
```{r}
# City distance plots
(Het_exp_dist_plot2 | Het_obs_dist_plot2) /
(Hom_exp_dist_plot2 | Hom_obs_dist_plot2 )
...
# Urbanization score plots
(Het_exp_usc_plot2 | Het_obs_usc_plot2) / 
(Hom_exp_usc_plot2 | Hom_obs_usc_plot2 )
