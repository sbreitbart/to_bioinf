...
ex_het_dist <- ggplot(data = exp_hom_dist_anova,
       aes(x = r_squared,
           y = p.value,
           label = R)) +
  geom_jitter(aes(
...
ex_het_usc <- ggplot(data = exp_hom_usc_anova,
       aes(x = r_squared,
           y = p.value,
           label = R)) +
  geom_jitter(aes(
...
obs_het_dist <- ggplot(data = obs_hom_dist_anova,
       aes(x = r_squared,
           y = p.value,
           label = R)) +
  geom_jitter(aes(
...
obs_het_usc <- ggplot(data = obs_hom_usc_anova,
       aes(x = r_squared,
           y = p.value,
           label = R)) +
  geom_jitter(aes(
...
obs_hom_dist <- ggplot(data = obs_hom_dist_anova,
  ...
  geom_jitter(aes(
       ...
       width = 0.0005,
       size = 2)  +
  ggtitle(label = "Observed homerozygosity",
          subtitle = "Distance to the City Center (continuous)") +
  facet_wrap(facets = "min_maf",
             labeller = "label_both",
             strip.position = c("top")) +
