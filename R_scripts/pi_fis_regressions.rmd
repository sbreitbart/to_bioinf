...
diversity_variant_sites <- here::here("./summary_stats/old/mmaf0.05_R1_populations_output/populations.sumstats_summary.tsv") %>%
...
all_anovas_cat %>%
  ...
  bold(~ p <= 0.05) %>%
  flextable::autofit() %T>%
  flextable::save_as_image(here::here("./Figures_Tables/regressions/pi_fis_cat_anova.png"))
```
