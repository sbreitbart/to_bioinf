...
```{r}
# 2.5 km
export_corr_table_fig(correlogram_utm, all_indiv_2500m)

# 10 km
export_corr_table_fig(correlogram_utm_10km, all_indiv_10km)
```

## Urban
```{r}
# 2.5 km
export_corr_table_fig(correlogram_utm_urb, urban_2500m)

# 3 km
export_corr_table_fig(correlogram_utm_urb_3km, urban_3km)

# 10 km
export_corr_table_fig(correlogram_utm_urb_10km, urban_10km)

# 12 km
export_corr_table_fig(correlogram_utm_urb_12km, urban_12km)
```

## Rural
```{r}
# 10 km
export_corr_table_fig(correlogram_utm_rur, rural_10km)

# 12 km
export_corr_table_fig(correlogram_utm_rur_12km, rural_12km)
```
...
```{r}
# 2.5 km
export_corr_table_fig(correlogram_utm_subsamp, one_indiv_2500m)

# 10 km
export_corr_table_fig(correlogram_utm_subsamp_10km, one_indiv_10km)
```

## 1 individual/site: Urban
```{r}
# 2.5 km
export_corr_table_fig(correlogram_utm_urb_subsamp, one_indiv_urban_2500m)

# 3 km
export_corr_table_fig(correlogram_utm_urb_subsamp_3km, one_indiv_urban_3km)

# 10 km
export_corr_table_fig(correlogram_utm_urb_subsamp_10km, one_indiv_urban_10km)

# 12 km
export_corr_table_fig(correlogram_utm_urb_subsamp_12km, one_indiv_urban_12km)
```

## 1 individual/site: Rural
```{r}
# 10 km
export_corr_table_fig(correlogram_utm_rur_subsamp, one_indiv_rural_10km)

# 12 km
export_corr_table_fig(correlogram_utm_rur_subsamp_12km, one_indiv_rural_12km)
```
