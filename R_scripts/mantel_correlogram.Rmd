...
# vcf
vcf_urb2 <- read.vcfR(
  here::here("./filtered_vcfs/urban_pops_usc_mmaf0.05_variant_sites.recode.vcf"), verbose = FALSE)
...
# vcf
vcf_rur2 <- read.vcfR(
  here::here("./filtered_vcfs/rural_pops_usc_mmaf0.05_variant_sites.recode.vcf"), verbose = FALSE)
...
## urb = urb score
genetic_distance_matrix_urb2 <- poppr::prevosti.dist(my_genind_urb2)
...
## urb = urb score
genetic_distance_matrix_rur2 <- poppr::prevosti.dist(my_genind_rur2)
