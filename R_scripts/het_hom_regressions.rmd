...
# remove mentions of pi and private alleles from this Rmd
# focus only on obs/exp hom/het ~ urb
...
diversity_all_sites %>%
  dplyr::select(1, 3, "exp_het", "obs_het", "exp_hom", "obs_hom", "num_indv", "City_dist", "urb_score") %>%
  view
