...
global_taj <- read.delim(
  here::here("./pi_fst_TajD_estimates/TajD_mmaf0.007968_R0.5_no-IBD_vcf-all/global_TajD_window_1mil/global_TajD.Tajima.D")) %>%
...
global_taj_100k <- read.delim(
  here::here("./pi_fst_TajD_estimates/TajD_mmaf0.007968_R0.5_no-IBD_vcf-all/global_TajD_window_100k/global_TajD_window_100k.Tajima.D")) %>%
  # remove windows with 0 SNPs
  dplyr::filter(N_SNPS != 0) 
...
```{r}
urb_taj <- read.delim(
  here::here("./pi_fst_TajD_estimates/TajD_mmaf0.007968_R0.5_no-IBD_vcf-all/Urban_dist_TajD_window_1mil/Urban_dist_TajD_window_1mil.Tajima.D")) %>%
  # remove windows with 0 SNPs
  dplyr::filter(N_SNPS != 0) 
...
urb_taj_100k <- read.delim(
  here::here("./pi_fst_TajD_estimates/TajD_mmaf0.007968_R0.5_no-IBD_vcf-all/Urban_dist_TajD_window_100k/Urban_dist_TajD_window_100k.Tajima.D")) %>%
  # remove windows with 0 SNPs
  dplyr::filter(N_SNPS != 0) 
...
```{r}
rur_taj <- read.delim(
  here::here("./pi_fst_TajD_estimates/TajD_mmaf0.007968_R0.5_no-IBD_vcf-all/Rural_dist_TajD_window_1mil/Rural_dist_TajD_window_1mil.Tajima.D")) %>%
  # remove windows with 0 SNPs
  dplyr::filter(N_SNPS != 0) 
...
rur_taj_100k <- read.delim(
  here::here("./pi_fst_TajD_estimates/TajD_mmaf0.007968_R0.5_no-IBD_vcf-all/Rural_dist_TajD_window_100k/Rural_dist_TajD_window_100k.Tajima.D")) %>%
  # remove windows with 0 SNPs
  dplyr::filter(N_SNPS != 0) 
