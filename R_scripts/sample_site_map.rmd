...
# This is from the original 100 scattershot survey.
# I added sites sampled in a prior study, too, so there are >100 sites.

max(sites$City_dist)
sum(sites$u_r_dist == "Urban")
sum(sites$u_r_dist == "Rural")
sum(sites$u_r_usc == "Urban")
sum(sites$u_r_usc == "Rural")
