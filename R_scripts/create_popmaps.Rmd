...
full_popmap %>%
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_all_dist.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
full_popmap %>%
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_all_usc.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
# urban vs. rural, determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_UR_usc.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
# urban , determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_UR_dist_URBAN.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
# urban , determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_U_usc.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
# urban , determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_UR_usc_URBAN.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
output_dir <- here("./genomic_resources/pop_maps_urban_usc")
...
# urban , determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_UR_dist_RURAL.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
# urban , determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_R_usc.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
# urban , determined by dist to CC
  ...
  write.table(., 
            file = here::here("./clean_data/pop_map3_UR_usc_RURAL.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
output_dir <- here("./genomic_resources/pop_maps_rural_usc")
...
uniques %>%
  write.table(., 
            file = here::here("./clean_data/pop_map3_1indiv_per_pop.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
uniques %>%
  write_csv(., 
            file = here::here("./clean_data/pop_map3_1indiv_per_pop.csv"))
```
...
uniques_urb %>%
  write.table(., 
            file = here::here("./clean_data/pop_map3_1indiv_per_pop_URBAN.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
uniques_urb %>%
  write_csv(., 
            file = here::here("./clean_data/pop_map3_1indiv_per_pop_URBAN.csv"))
```
...
uniques_rur %>%
  write.table(., 
            file = here::here("./clean_data/pop_map3_1indiv_per_pop_RURAL.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
uniques_rur %>%
  write_csv(., 
            file = here::here("./clean_data/pop_map3_1indiv_per_pop_RURAL.csv"))
```
...
multi_indiv_pops %>%
  write.table(., 
            file = here::here("./clean_data/pop_map3_MORE_THAN_1indiv_per_pop.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
multi_indiv_pops %>%
  write_csv(., 
            file = here::here("./clean_data/pop_map3_MORE_THAN_1indiv_per_pop.csv"))
```
...
write.table(larger_urb_pops, 
            file = here::here("./clean_data/pop_map3_MORE_THAN_1indiv_per_pop_URBAN.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
larger_urb_pops %>%
  write_csv(., 
            file = here::here("./clean_data/pop_map3_MORE_THAN_1indiv_per_pop_URBAN.csv"))
...
write.table(larger_rur_pops, 
            file = here::here("./clean_data/pop_map3_MORE_THAN_1indiv_per_pop_RURAL.txt"),
            stdout(),
            sep='\t',
            quote = FALSE,
            row.names = FALSE,
...
larger_rur_pops %>%
  write_csv(., 
            file = here::here("./clean_data/pop_map3_MORE_THAN_1indiv_per_pop_RURAL.csv"))
