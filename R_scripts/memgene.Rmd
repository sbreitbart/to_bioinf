...
gen_data_subsamp_rural <- process_vcf_data(
  here::here("./filtered_vcfs/1indiv_per_mmaf0.05_variant_sites_RURAL.recode.vcf")
  )
```
...
coords_rural <- process_location_data(
  here::here("./clean_data/urb_metrics.csv"),
  here::here("./clean_data/pop_map3_R_dist.csv"))
...
coords_subsamp_rural <- process_location_data(
  here::here("./clean_data/urb_metrics.csv"),
  here::here("./clean_data/pop_map3_1indiv_per_pop_RURAL.csv"))
...
milkweed_analysis_rural <- mgQuick(gen_data_rural, coords_rural)
...
milkweed_analysis_subsamp_rural <- mgQuick(gen_data_subsamp_rural, coords_subsamp_rural)
# No significant MEMs detected
