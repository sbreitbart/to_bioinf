...
# without legend
png(#here::here("./Figures_Tables/memgene/memgene_no_legend.png"),
        paste0("./Figures_Tables/memgene/memgene_nolegend_",           "var2_",
               group,
               today(),
               ".png"),
        width = 20,
...
# without legend
png(#here::here("./Figures_Tables/memgene/memgene_no_legend.png"),
        paste0("./Figures_Tables/memgene/memgene_nolegend_",           "var3_",
               group,
               today(),
               ".png"),
        width = 20,
...
terrain_plot_mems <- function(group, # e.g., all_indiv
  ...
  for (i in 1:3) {
    ...
    ggsave(filename =
             paste0("./Figures_Tables/memgene/memgene_terrain_bw_", 
               "var",
               i,
               "_",
               group,
    ...
    basemap_terrain +
      ...
      ggsave(filename =
               paste0("./Figures_Tables/memgene/memgene_terrain_greyscale_",
               "var",
               i,
               "_",
               group,
    ...
    ggsave(filename =
paste0("./Figures_Tables/memgene/memgene_terrain_color_",
               "var",
               i,
               "_",
               group,
...
```{r}
# create MEM dfs
mem1_urban <- create_mem(milkweed_analysis_urban,
                         coords_urban, 1)
mem2_urban <- create_mem(milkweed_analysis_urban,
                         coords_urban, 2)
mem3_urban <- create_mem(milkweed_analysis_urban,
                         coords_urban, 3)

# create maps
terrain_plot_mems("urban",
                            coords_urban, 
                            milkweed_analysis_urban,
                            mem1_urban,
                            mem2_urban,
                            mem3_urban)
```
...
### Rescaling MEMs from 0-255, then combining
#### Rescale
```{r}
# get mem1, mem2, and mem3 objects from '### Plots with terrain basemap' chunk above

# rescale mems from 0-255
mem1 %<>%
  dplyr::mutate(mem_255 = scales::rescale(var,
                                  to = c(0,255)))
